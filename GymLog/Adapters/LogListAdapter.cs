...
namespace GymLog.Adapters
{
    public class LogListAdapter : RecyclerView.Adapter
    {
        ...
        public LogListAdapter(Context context, List<ExerciseLog> logs)
        {
            _context = context;
            _logs = logs;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.row_exercise_detail_log, parent, false);
