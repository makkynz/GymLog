...
{
    public class AddExerciseListAdapter : RecyclerView.Adapter
    {
        private List<Exercise> _exercises;
        private Context _context;
        public event EventHandler<int> ItemAddClick;

        public AddExerciseListAdapter(Context context, List<Exercise> exercises)
        {
            _context = context;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.row_add_exercise, parent, false);
